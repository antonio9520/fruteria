...
export default function Debito2(props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.vwdatostarjeta}>
        <View>
          <TextInput style={styles.datostarjeta} placeholder="RUT" />
          <TextInput style={styles.datostarjeta} placeholder="Clave" />
        </View>
        <View style={{flexDirection: 'row'}}>
          ...
          <TouchableHighlight
            underlayColor="#FFFFFF"
            onPress={() => navigation.navigate('DebitoCargada')}>
